class TasksController < ApplicationController
  ...
  def get_spider
    ...
    @additional_function = @spider.additional_function
    str = render_to_string(template: "/tasks/_additional_function.html.erb",:locals=>{:additional_function=>@spider.additional_function})
    render json: {:type=>"#{@spider.has_keyword}",:add_funs=>str}
